...
import SpotifyTopCharts from "@/components/spotify/SpotifyTopCharts";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="w-full mt-12 mb-12">
          ...
          >
            ...
            <div className="p-0">
              {/* Top Section: Now Playing Headline */}
              <div className="p-6 border-b border-white/5 bg-white/[0.01]">
                <div className="w-full">
                  <div className="mb-6 flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-cyan tracking-[0.4em] uppercase font-bold">Currently_Broadcasting</span>
              ...
              {/* Bottom Section: Top Charts */}
              <div className="p-6">
                <div className="mb-6 flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-spotify animate-pulse" />
                  <span className="text-[10px] font-mono text-spotify tracking-[0.3em] uppercase font-bold">Top_Frequency_Logs</span>
                  <div className="h-[1px] flex-1 bg-gradient-to-r from-spotify/20 to-transparent" />
                </div>
                <SpotifyTopCharts />
              </div>
            </div>
