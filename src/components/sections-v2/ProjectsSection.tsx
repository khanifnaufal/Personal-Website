...
>(({ project, style, ...rest }, ref) => {
  ...
  // Border and Shadow effects that don't conflict with GSAP transform
  const hoverStyle = {
  ...
  return (
    ...
    >
      {/* Content Wrapper: Prevents hover effects from impacting GSAP transforms */}
      <div className="card-inner-content relative flex flex-col w-full h-full">
